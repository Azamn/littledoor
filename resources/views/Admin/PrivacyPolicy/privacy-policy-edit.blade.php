            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="card">
                        ...
                        <form class="widget-contact-form" id="privacyPolicyUpdate"
                            action={{ '/admin/update/privacy-policy/' . $privacyPolicyData['id'] }} method="POST"
...
<script>
    $(document).ready(function() {
        $('#privacyPolicyUpdate').on('submit', function(e) {
            e.preventDefault();
            e.stopPropagation();
            var form = this;
