                                                ...
                                                <table class="product-page-width">
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><a class="btn btn-primary" href=""> <i class="icon-eye"></i> View
                                                                    Certificate </a></td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                    ...
                    <div class="card-body">
                        <div class="accordion dark-accordion" id="accordionExample">
                            <div class="accordion-item accordion-wrapper">
                                <h2 class="accordion-header" id="headingOne">
                                    <button class="accordion-button collapsed accordion-light-primary txt-primary"
                                        type="button" data-bs-toggle="collapse" data-bs-target="#left-collapseOne5"
                                        aria-expanded="true" aria-controls="left-collapseOne">Appreciation</button>
                                </h2>
                    ...
                    <div class="card-body">
                        <div class="accordion dark-accordion" id="accordionExample">
                            <div class="accordion-item accordion-wrapper">
                                <h2 class="accordion-header" id="headingOne">
                                    <button class="accordion-button collapsed accordion-light-primary txt-primary"
                                        type="button" data-bs-toggle="collapse" data-bs-target="#left-collapseOne6"
                                        aria-expanded="true" aria-controls="left-collapseOne">Other Document</button>
                                </h2>
