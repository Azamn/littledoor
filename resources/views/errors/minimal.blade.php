...
<head>
    ...
    <meta name="Little Door" content="Little Door">
    <meta name="keywords"
...
<body class="antialiased">
    ...
    <div class="page-header" style="background-color:#c5c2d0; height: 130px;" >
        <div class="header-wrapper bg-primmrary row m-0">
            ...
            <div class="header-logo-wrapper">
                <div class="logo-wrapper" style="margin-left: 80px"><img class="relative flex items-top justify-center min-h-screen"
    ...
    <div
        ...
        <div class="mx-auto sm:px-6 lg:px-12">
            ...
            <p style="font-size: 2rem"> <strong> Privacy Policy </strong><p>
